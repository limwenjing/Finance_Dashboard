...
function FinanceDashboard() {
    ...
    return(
        <div className="FinanceDashboardDesign">
            ...
            <input type="text" id="symbol" placeholder="Stock Symbol" value={stock} onChange={(e) => setStock(e.target.value)} />
            <input type="number" id="quantity" placeholder="Quantity" value={quantity} onChange={(e) => setQuantity(e.target.value)} />
            <input type="number" id="price" placeholder="Purchase Price" step = "0.01" value={price} onChange={(e) => setPrice(e.target.value)} />
            <button id="button" onClick={handleAddItem}>Add Stock</button>
